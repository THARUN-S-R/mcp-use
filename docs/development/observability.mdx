...
- **[LangSmith](https://smith.langchain_classic.com/)** - LangChain's observability platform
...
<Steps>
  <Step title="Sign Up">
    Visit [smith.langchain_classic.com](https://smith.langchain_classic.com/) and create an account
  </Step>
...
- **LangSmith Documentation**: [smith.langchain_classic.com](https://smith.langchain_classic.com/)
