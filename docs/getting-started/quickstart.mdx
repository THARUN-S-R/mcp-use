...
mcp_use works with various LLM providers through langchain_classic. You'll need to install the appropriate LangChain provider package for your chosen LLM:
...
<Tip>
For other providers, check the [LangChain chat models documentation](https://python.langchain_classic.com/docs/integrations/chat/)
</Tip>
...
<Tip>
Uses LangChain's streaming API. See [streaming documentation](https://python.langchain_classic.com/docs/how_to/streaming/) for more details.
</Tip>
